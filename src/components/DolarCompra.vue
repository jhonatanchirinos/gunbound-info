...
<template>
  <div>
    <div class="flex flex-col items-center my-2">
      <span class="text-gray-700 text-xs">Monto mínimo $1.00</span>
    </div>
    ...
    <section class="flex flex-col items-center">
      ...
      <div class="flex flex-col items-center">
        <span class="text-gray-700 text-xs my-3"
          >Usa tu cupón <b class="cursor-pointer">aquí</b> .</span
        >
        <span class="text-gray-700 text-[11px] max-w-[37ch] text-center"
          >Tipo de cambio preferencial para montos mayores a $3,000 o su equivalente en soles.</span
        >
        <span class="text-gray-700 text-[11px] w-48 text-center"
